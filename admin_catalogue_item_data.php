<?php
	...
	if(!$FieldNames) $FieldNames = array(
		'position_incat','position_initem','position',
		'name',
	...
	if ($editid && $edit_result && mysql_num_rows($edit_result)) {
		...
		$my_image_highres = getImgDirSession('highres').$edit_arr['image_large'];
		$my_image_large = getImgDirSession('large').$edit_arr['image_large'];
		$my_image_primary = getImgDirSession('primary').$edit_arr['image_large'];
		$my_image_thumb = getImgDirSession('thumbs').$edit_arr['image_large'];

		if($HasCustomThumb) $my_CustomThumb = getImgDirSession('thumbs').$edit_arr['image_small'];
